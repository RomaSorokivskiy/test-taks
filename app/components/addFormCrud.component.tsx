...
import {FetchCrudList, FunctionAddCrud, RemoveCrud} from "app/app/reducers/Action";
import {connect, useDispatch} from "react-redux";


const AddFormCrudComponent = (props:any) => {
    ...
    const handleSubmit = (e:any) => {
        e.preventDefault()
        setForm({...form, birthday_date:new Date().toLocaleDateString('en-ZA', {year:'numeric', month:'2-digit', day:'2-digit'}).replaceAll('/','-')})
        // @ts-ignore
        dispatch(FunctionAddCrud(form))
    ...
    return(
        <form className="fixed top-[140px] left-[30%] w-[600px] min-h-[500px] flex flex-col justify-evenly items-center bg-gradient-to-r from-[#0acffe] to-[#495aff] rounded-3xl py-8 shadow-2xl" onSubmit={(e) => handleSubmit(e)}>
            ...
            <button type="submit" className="w-[200px] p-2 bg-gradient-to-r from-[#20E2D7] to-[#F9FEA5] rounded-2xl text-[#434343] font-bold shadow-xl">Create</button>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddFormCrudComponent);